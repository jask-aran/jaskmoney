...
func NewKeyRegistry() *KeyRegistry {
	...
	reg(scopeSettingsModeCat, actionUp, "", []string{"up", "ctrl+p"}, "prev field")
	reg(scopeSettingsModeCat, actionDown, "", []string{"down", "ctrl+n"}, "next field")
	reg(scopeSettingsModeCat, actionLeft, "", []string{"left"}, "prev color")
	reg(scopeSettingsModeCat, actionRight, "", []string{"right"}, "next color")
	reg(scopeSettingsModeCat, actionSave, "", []string{"enter"}, "save")
	reg(scopeSettingsModeCat, actionClose, "", []string{"esc"}, "cancel")
	reg(scopeSettingsModeTag, actionUp, "", []string{"up", "ctrl+p"}, "prev field")
	reg(scopeSettingsModeTag, actionDown, "", []string{"down", "ctrl+n"}, "next field")
	reg(scopeSettingsModeTag, actionLeft, "", []string{"left"}, "prev")
	reg(scopeSettingsModeTag, actionRight, "", []string{"right"}, "next")
	reg(scopeSettingsModeTag, actionSave, "", []string{"enter"}, "save")
	reg(scopeSettingsModeTag, actionClose, "", []string{"esc"}, "cancel")
	reg(scopeRuleEditor, actionUp, "", []string{"up", "ctrl+p"}, "up")
	reg(scopeRuleEditor, actionDown, "", []string{"down", "ctrl+n"}, "down")
	reg(scopeRuleEditor, actionLeft, "", []string{"left"}, "prev")
	reg(scopeRuleEditor, actionRight, "", []string{"right"}, "next")
	...
	reg(scopeFilterEdit, actionUp, "", []string{"up", "ctrl+p"}, "prev field")
	reg(scopeFilterEdit, actionDown, "", []string{"down", "ctrl+n"}, "next field")
	reg(scopeFilterEdit, actionLeft, "", []string{"left"}, "left")
	reg(scopeFilterEdit, actionRight, "", []string{"right"}, "right")
