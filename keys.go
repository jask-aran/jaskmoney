...
func NewKeyRegistry() *KeyRegistry {
	...
	reg(scopeTransactions, actionSortDirection, "txn:sort-dir", []string{"S"}, "")
	...
	reg(scopeTransactions, actionJumpTop, "txn:jump-top", []string{"g"}, "top/bottom")
	reg(scopeTransactions, actionJumpBottom, "txn:jump-bottom", []string{"G"}, "")
	...
	reg(scopeRuleEditor, actionSelect, "", []string{"enter"}, "pick/save")
	...
	reg(scopeSettingsActiveRules, actionRuleMoveUp, "", []string{"K"}, "reorder")
	reg(scopeSettingsActiveRules, actionRuleMoveDown, "", []string{"J"}, "")
	reg(scopeSettingsActiveRules, actionApplyAll, "rules:apply", []string{"A"}, "apply")
