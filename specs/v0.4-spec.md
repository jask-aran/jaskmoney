...
- Rule/category/tag editor modals enforce the universal text-input modal safety rule: `h/j/k/l` are never interpreted as navigation in these contexts, even under custom keybinding overrides.
